                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-7">
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            <li><a class="active" href="userindex">home</a></li>
                                ...
                                <div class="col-xl-9 col-md-9">
                                    <div class="music_field">
                                            <div class="thumb">
                                                ...
                                                <source src="{{ url('frontend/img/music_man/WhatsApp Audio 2024-04-01 at 12.22.59_eadfb837.mp3')}}">
                                                </div>
                                                <div class="audio_name">
                                                    <div class="name">
                                                        <h4>Frando Kally</h4>
                                                        ...
                                                        <audio preload="auto" controls>
                                                            <source src="{{ url('frontend/img/music_man/WhatsApp Audio 2024-04-01 at 12.23.44_276104ed.mp3')}}">
                                                            </audio>
                                                </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-9 col-md-9">
                                    <div class="music_field">
                                            <div class="thumb">
                                                ...
                                                <source src="{{ url('frontend/img/music_man/WhatsApp Audio 2024-04-01 at 12.23.48_6451fb7b.mp3')}}">
                                                </div>
                                                <div class="audio_name">
                                                    <div class="name">
                                                        <h4>Frando Kally</h4>
                                                        ...
                                                        <audio preload="auto" controls>
                                                            <source src="{{ url('frontend/img/music_man/WhatsApp Audio 2024-04-01 at 12.23.51_393559f1.mp3')}}">
                                                            </audio>
                                                </div>
                                    </div>
                                </div>
