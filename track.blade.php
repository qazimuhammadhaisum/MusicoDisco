                    ...
                    <div class="header_bottom_border">
                        <div class="row align-items-center">
                            <div class="col-xl-3 col-lg-2">
                                <div class="logo">
                                    <a href="userindex">
                                        <img src="{{ url('frontendimg/logo.png')}}" alt="">
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a class="active" href="track">tracks</a></li>
                        ...
                        @foreach($mr as $pro)
                                <div class="col-xl-9 col-md-9">
                                    <div class="music_field">
                                            <div class="thumb">
                                                    {{-- <img src="{{$pro->image}}" controls  width="200px" alt=""> --}}
                                                    <img src="{{'image/'.$pro->image}}" controls   width="200px" height="150px" >
                                                ...
                                                <div class="audio_name">
                                                    <div class="name">
                                                        ...
                                                        <audio  src="{{'music/'.$pro->music}}"  preload="auto" controls>
                                ...
                                <div class="col-xl-9 col-md-9">
                                    <div class="music_field">
                                            <div class="thumb">
                                                ...
                                                <div class="audio_name">
                                                    <div class="name">
                                                        <h4>Ustad Nusrat Fateh Ali Khan</h4>
                                                        <p>10 November, 2019</p>
                                                    </div>
                                                        <audio preload="auto" controls>
                                                                <source src="{{ url('frontend/img/music_man/WhatsApp Audio 2024-03-18 at 11.54.41 AM.mp4')}}">
                                                            </audio>
                                                </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="thumb">
                                                ...
                                                <div class="audio_name">
                                                    <div class="name">
                                                        ...
                                                        <audio preload="auto" controls>
                                                                <source src="{{ url('frontend/img/music_man/WhatsApp Audio 2024-03-18 at 12.04.36 PM.mp4')}}">
                                                            </audio>
                                                </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-10">
                    <div class="row align-items-center">
                                <div class="col-xl-9 col-md-9">
                                    <div class="music_field">
                                            <div class="thumb">
                                                    <img src="{{ url('frontend/img/music_man/4.png')}}" alt="">
                                                </div>
                                                <div class="audio_name">
                                                    <div class="name">
                                                        <h4>raza sha</h4>
                ...
                <div class="col-xl-10">
                    <div class="row align-items-center">
                                <div class="col-xl-9 col-md-9">
                                    <div class="music_field">
                                            <div class="thumb">
                                                    <img src="{{ url('frontend/img/music_man/5.png')}}" alt="">
                                                </div>
                                                <div class="audio_name">
                                                    <div class="name">
                                                        <h4>rafi zaman</h4>
                ...
                <div class="col-xl-10">
                    <div class="row align-items-center">
                                <div class="col-xl-9 col-md-9">
                                    <div class="music_field">
                                            <div class="thumb">
                                                    <img src="{{ url('frontend/img/music_man/6.png')}}" alt="">
                                                </div>
                                                <div class="audio_name">
                                                    <div class="name">
                                                        <h4>awais khan</h4>
